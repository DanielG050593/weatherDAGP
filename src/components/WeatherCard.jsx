            ...
            <div className='weather__info'>
                ...
                <ul className='weather__list'>
                    <li className='weather__list-item'>
                        ...
                        <span>{weather?.wind.speed} meter/sec</span></li>
                    <li className='weather__list-item'>
                        <span className='weather__list-label'>Clouds: </span>
                        <span className='weather__list-value'>{weather?.clouds.all}%</span></li>
                    <li className='weather__list-item'>
                        <span className='weather__list-label'>Pressure: </span>
                        <span className='weather__list-value'>{weather?.main.pressure} hPa</span></li>
                </ul>
            </div>
